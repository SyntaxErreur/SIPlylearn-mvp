...
import { Course, Investment } from "@shared/schema";
import { useAuth } from "@/hooks/use-auth";
import CourseCard from "@/components/course-card";
import { Button } from "@/components/ui/button";
import { Tabs, TabsContent, TabsList, TabsTrigger } from "@/components/ui/tabs";
import { Input } from "@/components/ui/input";
import { Bell, Search, Filter, User, BookOpen, TrendingUp, BarChart3, Scroll, FileText, Play } from "lucide-react";
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <div className="space-y-4">
              ...
              <Card key={course.id} className="p-4">
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-muted-foreground mb-1">{course.author}</p> {/* Added author name */}
            ...
            {/* Example ongoing courses with mock data */}
            <Card className="p-4">
              <div className="flex items-center gap-4">
                <div className="w-16 h-16 relative rounded-lg overflow-hidden">
                  <img 
                    src="https://images.unsplash.com/photo-1579532536935-619928decd08?w=800"
                ...
                <div className="flex-1">
                  <h3 className="font-medium mb-2">Master in Finance (Zero to Hero)</h3>
                  <p className="text-sm text-muted-foreground mb-1">Chanuka Saranga</p>
                  <div className="flex justify-between text-sm text-muted-foreground mb-2">
            ...
            <Card className="p-4">
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1">
                  <h3 className="font-medium mb-2">Master in Fintech (Zero to Hero)</h3>
                  <p className="text-sm text-muted-foreground mb-1">Sahan Lakshitha</p>
                  <div className="flex justify-between text-sm text-muted-foreground mb-2">
                    <span>43% Completed</span>
                    <Link href="/course/2">
                      <span className="text-primary hover:underline">Continue Learning</span>
